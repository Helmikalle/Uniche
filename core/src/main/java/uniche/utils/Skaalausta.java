...
public final class Skaalausta {
    ...
    public static final short PONY_BIT = 2;
    public static final short CUPCAKE_BIT = 4;
    public static final short MANGO_BIT = 8;
    public static final short WASTE_BIT = 16;
}
